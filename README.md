...
[![npm](https://img.shields.io/npm/v/@cndllabs/widgets)](https://www.npmjs.com/package/@cndllabs/widgets)
...
The `@cndllabs/widgets` package is an [npm package](https://www.npmjs.com/package/@cndllabs/widgets) of React components used to provide subsets of the Uniswap Protocol functionality in a small and configurable user interface element.
...
```js
yarn add @cndllabs/widgets redux react-redux
```
```js
npm i --save @cndllabs/widgets redux react-redux
```
